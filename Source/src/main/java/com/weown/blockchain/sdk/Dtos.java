...
public class Dtos {
    ...
    public static class SubmitVoteWeightTxActionDto {
        ...
        public SubmitVoteWeightTxActionDto(String accountHash, String assetHash, String resolutionHash,
                float voteWeight) {
            setAccountHash(accountHash);
            setAssetHash(assetHash);
            setResolutionHash(resolutionHash);
    ...
    public static class SetAccountEligibilityTxActionDto {
        ...
        public SetAccountEligibilityTxActionDto(String accountHash, String assetHash, boolean isPrimaryEligible,
    ...
    public static class ChangeKycControllerAddressTxActionDto {
        ...
        public ChangeKycControllerAddressTxActionDto(String accountHash, String assetHash,
                String kycControllerAddress) {
            setAccountHash(accountHash);
            setAssetHash(assetHash);
